...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<UserController>(builder: (_, controller, ___) {
      return Scaffold(
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          UserProfileInfoBox(
                              info:
                              "Total Completed Orders: ${controller
                                  .totalOrders}"),
                          Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    //   ),
                                    // );
                                    String userType = await UserController()
                                        .getUserType(context);
                                    print(userType);
                                    if (userType == "general") {
                                      print(true);
